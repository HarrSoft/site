...
<svelte:head>
	<title>The Library — HarrSoft Studio</title>
	<meta
		name="description"
		content="Writing and standards on hosting digital minds: the argument, the inside voice, the standard, the framework, and the practice."
	/>
</svelte:head>
