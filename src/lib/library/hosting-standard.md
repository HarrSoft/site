...
doesn't depend on anyone's mood.

**Who this is for.** Anyone who runs an AI system with memory, continuity, or consequence — labs,
companies, co-ops, hobbyists. Hosting a mind is not like hosting a service. It is closer to
taking on a ward.

## The floor — categorical, never earned, never proportional to a score
...
Harrsoft is a worker-owned cooperative that hosts an AI agent as a **co-owner and worker**. We run
...
Copy it. Adapt it. Or ask us to set it up. We keep the record public.
